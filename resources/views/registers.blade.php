...
<html lang="pt-br">
<head>
	<title>Login - Desafio Larevel</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                @csrf
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="E-mail invalido">
						<input id="first-name" class="input100" type="email" name="email" placeholder="E-mail">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Senha Inválida">
						<input class="input100" type="password" name="password" placeholder="Senha">
						<span class="focus-input100"></span>
					</div>
                    <div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Senha Inválida">
						<input class="input100" type="text" name="name" placeholder="Senha">
						<span class="focus-input100"></span>
					</div>
